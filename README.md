...
| Hover shows who | On (the default): hover a body drawn away from its tile to see who it is. What a click does is unchanged. |
| Arrow to their tile | On (the default): while you hover someone, a small arrow points to the tile they really stand on. |
