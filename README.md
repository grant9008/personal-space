...
| Hide players below | Off (the default), or a combat level: anyone below it isn't drawn or clickable, and neither is their overhead chat, health bar or hitsplats, as with Entity Hider. Friends, friends chat and clan members always stay. Off in PvP areas and while you fight. |
