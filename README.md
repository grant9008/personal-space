...
| Draw me in front | Off (the default): whoever is between you and the camera covers you, as they really would, and a pair or trio near you (at a fire, say) keeps its shape. Busy piles still step out of your way. On: you're always drawn over anyone right up against you, and small groups near you step out of your line of sight too, so you can see yourself whichever way the camera faces. |
